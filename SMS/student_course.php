...
echo "ERRROR IN REGISTRATION(YOU HAVE ALREADY SELECTED 5 COURSES)";
exit();
}
}
    ...
    foreach($reg3 as $value3)
      {
        ...
        $reg4=mysql_fetch_assoc($r4); 
         ...
         $sum=$sum + $value4;		 
         		    ...
         		    if($sum < 24)										//If credit hours are less then 24 then registration error
					{
					printf("REGISTRATION ERROR(TOTAL CREDIT IS LESS THAN 24)");
					exit();
					}  
 }
} 
