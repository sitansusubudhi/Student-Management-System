...
<form method="post" action="view_exam_results.php" >
<input type="submit" class="myButton" name="add" value="VIEW EXAMINATION RESULTS">
</form>
<form method="post" action="view_attendance_details.php" >
<input type="submit" class="myButton" name="add" value="VIEW ATTENDANCE DETAILS">
</form>
